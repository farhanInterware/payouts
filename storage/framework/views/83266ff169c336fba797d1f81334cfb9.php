...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Payouts Payment System'); ?></title>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container-fluid">
            ...
            <?php endif; ?>
            <a class="navbar-brand" href="<?php echo e(auth()->check() ? (auth()->user()->isAdmin() ? route('admin.dashboard') : route('user.dashboard')) : route('login')); ?>">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li>
                                    <a class="dropdown-item" href="<?php echo e(auth()->user()->isAdmin() ? route('admin.profile.show') : route('user.profile.show')); ?>">
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <ul class="sidebar-menu">
            <?php if(auth()->user()->isAdmin()): ?>
                ...
                <li class="sidebar-menu-item">
                    <a href="<?php echo e(route('admin.transactions.index')); ?>" class="sidebar-menu-link <?php echo e(request()->routeIs('admin.transactions.*') ? 'active' : ''); ?>">
                ...
                <li class="sidebar-menu-item">
                    <a href="<?php echo e(route('admin.profile.show')); ?>" class="sidebar-menu-link <?php echo e(request()->routeIs('admin.profile.*') ? 'active' : ''); ?>">
            ...
            <?php else: ?>
                <li class="sidebar-menu-item">
                    <a href="<?php echo e(route('user.dashboard')); ?>" class="sidebar-menu-link <?php echo e(request()->routeIs('user.dashboard') ? 'active' : ''); ?>">
                        <i class="bi bi-speedometer2"></i>
                        <span>Dashboard</span>
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item">
                    <a href="<?php echo e(route('user.transactions.index')); ?>" class="sidebar-menu-link <?php echo e(request()->routeIs('user.transactions.index') || request()->routeIs('user.transactions.show') ? 'active' : ''); ?>">
                        <i class="bi bi-list-ul"></i>
                        <span>All Transactions</span>
                    </a>
                </li>
                <li class="sidebar-menu-item">
                    <a href="<?php echo e(route('user.transactions.create')); ?>" class="sidebar-menu-link <?php echo e(request()->routeIs('user.transactions.create') ? 'active' : ''); ?>">
                ...
                <li class="sidebar-menu-title">Account</li>
                <li class="sidebar-menu-item">
                    <a href="<?php echo e(route('user.profile.show')); ?>" class="sidebar-menu-link <?php echo e(request()->routeIs('user.profile.*') ? 'active' : ''); ?>">
                        <i class="bi bi-person-circle"></i>
                        <span>My Profile</span>
                    </a>
                </li>
    ...
    <div class="main-content <?php if(auth()->guard()->guest()): ?><?php echo e('expanded'); ?><?php endif; ?>" id="mainContent">
        ...
        <footer class="bg-white border-top mt-5 py-4">
            <div class="container text-center text-muted">
                <p class="mb-0">&copy; <?php echo e(date('Y')); ?> Payouts Payment System. All rights reserved.</p>
            </div>
        </footer>
    </div>
...
<?php /**PATH C:\xampp\htdocs\Debitly\resources\views/layouts/app.blade.php ENDPATH**/ ?>