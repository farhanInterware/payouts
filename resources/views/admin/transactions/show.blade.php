...
<div class="row">
            ...
            <div class="card-body">
                <div class="row g-4">
                    <div class="col-12 col-md-6">
                        <div class="mb-3">
                            <label class="text-muted small text-uppercase fw-semibold">User</label>
    ...
    <div class="col-12 col-md-4 mt-3 mt-md-0">
        <div class="card">
            ...
            <div class="card-body">
                <a href="{{ route('admin.transactions.index') }}" class="btn btn-outline-primary w-100 mb-2">
                    <i class="bi bi-list-ul me-2"></i>All Transactions
                </a>
                <a href="{{ route('admin.users.show', $transaction->user_id) }}" class="btn btn-outline-info w-100">
