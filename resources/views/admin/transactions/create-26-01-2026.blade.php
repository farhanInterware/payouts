            ...
            <div class="mb-4">
                ...
                <div class="row g-3">
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text" name="merchant_order_id" class="form-control" value="order-{{ time() }}" required>
            ...
            <div class="mb-4">
                ...
                <div class="row g-3">
                    <div class="col-12 col-md-6">
                        ...
                        <input type="email" name="customer_email" id="customer_email" class="form-control" placeholder="Enter customer email address" required>
                        <small class="text-muted">If the email doesn't exist, a new user will be created automatically.</small>
                    </div>
                </div>
            </div>
